<template>
	<div style="position: relative">
		...
		<input type='file' id='file-input' @change="_handleChange" @click="_handleClick" v-if="acceptMemi && acceptMime != 'any'" :accept="acceptMime"/>
		<input type='file' id='file-input' @change="_handleChange" @click="_handleClick" v-else />
		</button>
	</div>
</template>
